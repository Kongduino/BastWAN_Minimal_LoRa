...
void sha224_update(sha224_ctx *, const unsigned char *, unsigned int);
void sha224_final(sha224_ctx *, unsigned char *);
...
void sha384_update(sha384_ctx *, const unsigned char *, unsigned int);
void sha384_final(sha384_ctx *, unsigned char *);
void sha384(const unsigned char *, unsigned int, unsigned char *);

void sha512_init(sha512_ctx *);
void sha512_update(sha512_ctx *, const unsigned char *, unsigned int);
void sha512_final(sha512_ctx *, unsigned char *);
void sha512(const unsigned char *, unsigned int, unsigned char *);

inline uint32 sha224_h0[8] = {
  0xc1059ed8, 0x367cd507, 0x3070dd17, 0xf70e5939, 0xffc00b31, 0x68581511, 0x64f98fa7, 0xbefa4fa4
};

inline uint32 sha256_h0[8] = {
  0x6a09e667, 0xbb67ae85, 0x3c6ef372, 0xa54ff53a, 0x510e527f, 0x9b05688c, 0x1f83d9ab, 0x5be0cd19
};

inline uint64 sha384_h0[8] = {
  0xcbbb9d5dc1059ed8ULL, 0x629a292a367cd507ULL, 0x9159015a3070dd17ULL, 0x152fecd8f70e5939ULL,
  0x67332667ffc00b31ULL, 0x8eb44a8768581511ULL, 0xdb0c2e0d64f98fa7ULL, 0x47b5481dbefa4fa4ULL
};

inline uint64 sha512_h0[8] = {
  0x6a09e667f3bcc908ULL, 0xbb67ae8584caa73bULL, 0x3c6ef372fe94f82bULL, 0xa54ff53a5f1d36f1ULL,
  0x510e527fade682d1ULL, 0x9b05688c2b3e6c1fULL, 0x1f83d9abfb41bd6bULL, 0x5be0cd19137e2179ULL
};

inline uint32 sha256_k[64] = {
...
#ifndef UNROLL_LOOPS
    for (j = 0; j < 16; j++) PACK32(&sub_block[j << 2], &w[j]);
    for (j = 16; j < 64; j++) SHA256_SCR(j);
    for (j = 0; j < 8; j++) wv[j] = ctx->h[j];
    for (j = 0; j < 64; j++) {
...
void hmac_sha224_init(hmac_sha224_ctx*, const unsigned char*, unsigned int);
void hmac_sha224_reinit(hmac_sha224_ctx*);
void hmac_sha224_update(hmac_sha224_ctx*, const unsigned char*, unsigned int);
void hmac_sha224_final(hmac_sha224_ctx*, unsigned char*, unsigned int);
void hmac_sha224(const unsigned char*, unsigned int, const unsigned char*, unsigned int, unsigned char*, unsigned);

void hmac_sha256_init(hmac_sha256_ctx*, const unsigned char*, unsigned int);
void hmac_sha256_reinit(hmac_sha256_ctx*);
void hmac_sha256_update(hmac_sha256_ctx*, const unsigned char*, unsigned int);
void hmac_sha256_final(hmac_sha256_ctx*, unsigned char*, unsigned int);
void hmac_sha256(const unsigned char*, unsigned int, const unsigned char*, unsigned int, unsigned char*, unsigned);

void hmac_sha384_init(hmac_sha384_ctx*, const unsigned char*, unsigned int);
void hmac_sha384_reinit(hmac_sha384_ctx*);
void hmac_sha384_update(hmac_sha384_ctx*, const unsigned char*, unsigned int);
void hmac_sha384_final(hmac_sha384_ctx*, unsigned char*, unsigned int);
void hmac_sha384(const unsigned char*, unsigned int, const unsigned char*, unsigned int, unsigned char*, unsigned);

void hmac_sha512_init(hmac_sha512_ctx*, const unsigned char*, unsigned int);
void hmac_sha512_reinit(hmac_sha512_ctx*);
void hmac_sha512_update(hmac_sha512_ctx*, const unsigned char*, unsigned int);
void hmac_sha512_final(hmac_sha512_ctx*, unsigned char*, unsigned int);
void hmac_sha512(const unsigned char*, unsigned int, const unsigned char*, unsigned int, unsigned char*, unsigned);
